...
<body>
    ...
    <div class="container mt-4">
        <h2>Edit Contact</h2>
        <form method="post" action="addContact.cfm?int_contact_id=#url.int_contact_id#">
         <div class="mb-3">
         ...
         <div class="mb-3">
             <label for="str_contact" class="form-label">Contact</label>
             <input type="text" class="form-control" id="str_contact" name="str_contact" value="#contact.str_contact#" required>
         </div>
         <div class="mb-3">
         ...
         <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select id="str_qualification" name="int_qualification" class="form-select">
                   <cfif qryGetQualifications.recordCount GT 0>
                        <cfloop query="qryGetQualifications">
                            <option value="#qryGetQualifications.int_qualification_id#"
                                <cfif contact.int_qualification EQ qryGetQualifications.int_qualification_id>
                                    selected="selected"
                                </cfif>>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select id="int_country_id" name="int_country" class="form-select">
                     <cfif qryGetCountries.recordCount GT 0>
                        <cfloop query="qryGetCountries">
                            <option value="#qryGetCountries.int_country_id#"
                                <cfif contact.int_country EQ qryGetCountries.int_country_id>
                                    selected="selected"
                                </cfif>>
         ...
         <div class="mb-3">
             <label for="str_pincode" class="form-label">Pincode</label>
             <input type="text" class="form-control" id="str_pincode" name="str_pincode" value="#contact.str_pincode#">
         </div>
         <div class="mb-3">
...
>>>>>>> a2440b9a49b6003ca4ee90e669e4e0a926474230
